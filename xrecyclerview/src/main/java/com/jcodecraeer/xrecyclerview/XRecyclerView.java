...
public class XRecyclerView extends RecyclerView {
    ...
    protected long refreshBegin;//最后开始刷新时间
    ...
    public void refresh() {
        if (pullRefreshEnabled && mLoadingListener != null) {
            ...
            refreshBegin = System.currentTimeMillis();
...
//                setNoMore(false);
    ...
    private long getAfterTime() {
        return System.currentTimeMillis() - refreshBegin > MIN_SHOW_HEAD ?
                0 : MIN_SHOW_HEAD - (System.currentTimeMillis() - refreshBegin);
    }
